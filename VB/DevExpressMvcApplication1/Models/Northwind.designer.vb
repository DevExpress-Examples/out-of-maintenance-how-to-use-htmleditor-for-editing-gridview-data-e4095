...
Imports Microsoft.VisualBasic
	...
	<System.Data.Linq.Mapping.DatabaseAttribute(Name:="NWind")> _
	...
	#End Region
		...
		<Association(Name:="Region_Territory", Storage:="_Region", ThisKey:="RegionID", OtherKey:="RegionID", IsForeignKey:=True)> _
	...
	#End Region
		...
		<Association(Name:="Employee_Employee", Storage:="_Employees", ThisKey:="EmployeeID", OtherKey:="ReportsTo")> _
		...
		<Association(Name:="Employee_Order", Storage:="_Orders", ThisKey:="EmployeeID", OtherKey:="EmployeeID")> _
		Public Property Orders() As EntitySet(Of Order)
			Get
				Return Me._Orders
			End Get
		...
		<Association(Name:="Employee_Employee", Storage:="_Employee1", ThisKey:="ReportsTo", OtherKey:="EmployeeID", IsForeignKey:=True)> _
	...
	#End Region
		...
		<Association(Name:="Product_Order_Detail", Storage:="_Product", ThisKey:="ProductID", OtherKey:="ProductID", IsForeignKey:=True)> _
	...
	#End Region
		...
		<Association(Name:="Employee_Order", Storage:="_Employee", ThisKey:="EmployeeID", OtherKey:="EmployeeID", IsForeignKey:=True)> _
		...
		<Association(Name:="Shipper_Order", Storage:="_Shipper", ThisKey:="ShipVia", OtherKey:="ShipperID", IsForeignKey:=True)> _
	...
	#End Region
		...
		<Association(Name:="Product_Order_Detail", Storage:="_Order_Details", ThisKey:="ProductID", OtherKey:="ProductID")> _
		Public Property Order_Details() As EntitySet(Of Order_Detail)
			Get
				Return Me._Order_Details
			End Get
		...
		<Association(Name:="Supplier_Product", Storage:="_Supplier", ThisKey:="SupplierID", OtherKey:="SupplierID", IsForeignKey:=True)> _
	...
	#End Region
		...
		<Association(Name:="Region_Territory", Storage:="_Territories", ThisKey:="RegionID", OtherKey:="RegionID")> _
	...
	#End Region
		...
		<Association(Name:="Shipper_Order", Storage:="_Orders", ThisKey:="ShipperID", OtherKey:="ShipVia")> _
		Public Property Orders() As EntitySet(Of Order)
			Get
				Return Me._Orders
			End Get
	...
	#End Region
		...
		<Association(Name:="Supplier_Product", Storage:="_Products", ThisKey:="SupplierID", OtherKey:="SupplierID")> _
		Public Property Products() As EntitySet(Of Product)
			Get
				Return Me._Products
			End Get
	...
	Partial Public Class OrderDetail
		...
		<Column(Storage:="_UnitPrice", DbType:="SmallMoney NOT NULL")> _
		Public Property UnitPrice() As Decimal
			Get
				Return Me._UnitPrice
			End Get
		...
		<Column(Storage:="_Supplier", DbType:="NVarChar(217)")> _
	...
	Partial Public Class OrderReport
		...
		<Column(Name:="[Extended Price]", Storage:="_Extended_Price", DbType:="Money")> _
	...
	Partial Public Class SalesPerson
		...
		<Column(Name:="[Sales Person]", Storage:="_Sales_Person", DbType:="NVarChar(31) NOT NULL", CanBeNull:=False)> _
